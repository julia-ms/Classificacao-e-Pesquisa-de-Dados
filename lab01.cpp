...
int main(void){    
    ...
    loginfo = shellsort(array, MAX); //AAAAAAAAAAAAAAAAAAAAAAAAA
...
std::tuple<int, int, int> busca_binaria(array_t array, int elemento, int inicio, int fim){
   int comparacoes = 0, trocas = 0, meio = (inicio+fim)/2;
      ...
      do{
        /*
        for(auto i=inicio;i<fim;i++) cout << array[i] << " ";                     //para ver como esta o array 
        cout << endl;
        */
...
loginfo_t shellsort(array_t array, array_size_t array_size){
    int trocas = 0, comparacoes = 0, h, i, j, temp;
    ...
    do{
        ...
        for(i=h;i<MAX;i++){
            ...
            /*
            cout << endl;
            for(auto i=0;i<MAX;i++) cout << array[i] << " ";                     //para ver como esta o array 
            cout << endl;
            */
        }
    }while(h!=1);
